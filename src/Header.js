            ...
            <div class="rev-7-body">
                ...
                <div class="mobile-menu rev-7-mobile-menu d-lg-none d-block">
                    ...
                    <div class="m-main-menu">
                        ...
                        <ul class="menu-bar">
                            <li class="logo">
                                <img src="assets/images/logos/logo-6.png" alt="Logo" />
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="index-9.html">Home</a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="row">
                                    <div class="col-xxl-6 col-xl-7 col-lg-7">
                                        <div class="top-header-link d-lg-flex d-none">
                                            <span>Stote Location: 1234 Heaven Stress, Beverly Hill, Melbourne, USA.</span>
                                        </div>
                                    </div>
