            ...
            <div class="product-view-area">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-7 col-md-6">
                        <div class="part-txt">
                            <h2 class="main-product-title">NAME :- Headband Foldable Stereo Bluetooth Headphones Wireless Headset</h2>
                           
                            <ul class="short-details">
                                <li><span>$96.00</span> $75.00</li>
                                <li>Product Code: <span>#4657</span></li>
                                <li>PV <span>#4657</span></li>
                                <li>NET VOLUMES<span>#4657</span></li>
