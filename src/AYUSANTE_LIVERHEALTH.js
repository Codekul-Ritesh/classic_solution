                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-5 col-md-6">
                                <div class="part-img mr-30">
                                    <div class="img-box" id="bigPreview">
                                        <img src="assets/images/classic/ayurveda/image_48.png" alt="Image" />
                                    </div>
                            ...
                            <div class="col-xl-6 col-lg-7 col-md-6">
                                <div class="part-txt">
                                    ...
                                    <h3>Description</h3>
                                    <p class="dscr">Used as hepatoprotective. Widely recommended ingredients that are synergistically combined to provide optimum health benefits.</p>
...
export default AYUSANTE_LIVERHEALTH 
