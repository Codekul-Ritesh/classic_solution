                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-5 col-md-6">
                                <div class="part-img mr-30">
                                    <div class="img-box" id="bigPreview">
                                        <img src="assets/images/classic/personal care/image_122.png" alt="Image" />
                                    </div>
                            ...
                            <div class="col-xl-6 col-lg-7 col-md-6">
                                <div class="part-txt">
                                    ...
                                    <h3>Description</h3>
                                    <p class="dscr">Assure Active for men is an invigorating, refreshing fragrance with natural extracts that provides powerful odour protection all day long.</p>
